...
?>
    <div class="row">
        <div id="breadcrumb" class="col-xs-12">
            ...
            <ol class="breadcrumb pull-left">
                <li><a>Administrar Usuario</a></li>
                <li><a>Gestion de Usuario</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12 col-sm-4">
            ...
            <div class="box">
                ...
                <div class="box-content">
                    ...
                    <form id="defaultForm_2" method="POST" action="../Procesos/modificarUsuario.php" class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                <?php
                                    $resultado = mysqli_query($con,"SELECT idRol FROM usuariorol WHERE idUsuario=$ID_USUARIO");
                                    $rol_usuario = mysqli_fetch_assoc($resultado);
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="rol" value="<?php echo $row['idRol'];?>" <?php echo ($row['idRol']==$rol_usuario['idRol'])?'checked':'' ?>> <?php echo $row['nombre'];?>
                            ...
                            <div class="form-group">
                                ...
                                while ($row = mysqli_fetch_array($EXECUTE)):
                                    ...
                                    <div class="col-sm-5">
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="rol" value="<?php echo $row['idRol'];?>" checked> <?php echo $row['nombre'];?>
                                                <i class="fa fa-circle-o"></i>
                                            </label>
                                        </div>
                                    </div>
    ...
    <script>
        function modificarUsuario(id) {
            window.location.href = "index.php#ajax/formNuevoUsuario.php?id=" + id;
            location.reload();
        }

        function cambiarEstado(id,state) {
            window.location.href = "index.php#ajax/formNuevoUsuario.php?id_estado=" + id +"&state=" + state;
            location.reload();
        }
    </script>
