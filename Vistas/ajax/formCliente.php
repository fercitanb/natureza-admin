...
<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            <li><a>Administrar Cliente</a></li>
            <li><a>Gestión de Cliente</a></li>
        </ol>
    </div>
</div>
<div class="row">
            ...
            <div class="box-content">
                ...
                if (!empty($_GET['id'])){
                    ...
                    while ($DATA = mysqli_fetch_array($QUERY_USUARIO)):
                        ...
                        <form id="defaultForm_2" method="POST" action="../Procesos/modificarCliente.php" class="form-horizontal">
                            <fieldset>
                    ...
                    <form id="defaultForm_1" method="POST" action="../Procesos/insertarNuevoCliente.php" class="form-horizontal">
                        <fieldset>
                            <legend>Ingresar datos de cliente</legend>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">CI</label>
        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <table class="table" id="datatable-1">
                    ...
                    $QUERY = "SELECT u.idUsuario, u.ci, u.nombre, u.apPaterno, u.apMaterno, u.estado, u.email, r.idUsuario FROM usuario u, usuariorol r  WHERE u.idUsuario=r.idUsuario AND r.idRol=4";
...
<script>
    function modificarUsuario(id) {
        window.location.href = "index.php#ajax/formCliente.php?id=" + id;
        location.reload();
    }

    function cambiarEstado(id,state) {
        window.location.href = "index.php#ajax/formCliente.php?id_estado=" + id +"&state=" + state;
        location.reload();
    }
</script>
