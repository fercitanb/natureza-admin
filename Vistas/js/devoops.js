...
function ValidacionForms() {
	$('#defaultForm_1').bootstrapValidator({
		...
		fields: {
			...
			apellidoPaterno: {
				...
				validators: {
					notEmpty: {
						message: '*El Apellido Paterno es un campo requerido, no puede estar vacío'
					},
					regexp: {
						regexp: /^[a-zA-ZñÑ\s]+$/,
						message: 'El Apellido Paterno solo puede contener caracteres alfabéticos'
					}
				}
			},
			apellidoMaterno: {
				...
				validators: {
					regexp: {
						regexp: /^[a-zA-ZñÑ\s]+$/,
						message: 'El apellido materno solo puede contener caracteres alfabéticos'
					}
				}
			},
			ci: {
				message: 'El carnet no es válido',
				validators: {
					notEmpty: {
						message: '*El carnet es un campo requerido, no puede estar vacío'
					},
					stringlenght: {
						min: 5,
						max: 11,
			...
			carnet: {
				...
				validators: {
					...
					regexp: {
						regexp: (/^[a-z\s\-]+$/)|(/^[0-9\s\-]+$/),
						message: 'El carnet solo puede contener caracteres alfabéticos y numéricos'
					}
				}
			},
			numeroTelefono: {
				validators: {
					notEmpty: {
						message: '*El número de teléfono es un campo requerido, no puede estar vacío'
					},
					digits: {
			...
			username: {
				...
				validators: {
					notEmpty: {
						message: 'El usuario es un campo requerido, no puede estar vacío'
					},
					/*stringLength: {
					 min: 6,
					 max: 30,
			...
			email: {
				validators: {
					notEmpty: {
						message: 'El email es un campo requerido, no puede estar vacío'
					},
					emailAddress: {
			...
			password: {
				validators: {
					notEmpty: {
						message: 'La contraseña es un campo requerido, no puede estar vacío'
					},
					identical: {
			...
			confirmPassword: {
				validators: {
					notEmpty: {
						message: 'La confirmación de contraseña es requerida, no puede estar vacía'
					},
					identical: {
						field: 'password',
						message: 'Las contraseñas no coinciden'
...
function ValidacionUpdateForms() {
	...
	$('#defaultForm').bootstrapValidator({
		...
		fields: {
			...
			email: {
				validators: {
					notEmpty: {
						message: 'El email es requerido, no puede estar vacío'
					},
					emailAddress: {
...
$(document).ready(function () {
	...
	if (ajax_url.length < 1) {
		ajax_url = 'ajax/welcome.php';
	}//ajax/formNuevoUsuario.php
